...
::: danger 不要问一些弱智问题我们不想回答
我们不是企业工单客服，因此没有义务为您解决问题
企业工单客服有钱拿，我们只是一群没钱的开发者
如果确实有技术问题可以群内讨论
若只是单纯不会部署这边可以向群主支付2000-5000万元部署费用
保证给你服务的服服帖帖的把你当爸爸一样供着
:::
...
::: warning
 **警告**：自简儿 NEXT 3.1 起，Lagrange.OneBot 协议端已被官方废弃，所有关于 Lagrange 的教程和配置文件（如 `appsettings.json`）均已不再维护。
实际Lagrange官方抛弃了Onebot协议，改开发Langrange.Milky（LagrangeV2），但是Jianer开发者不愿意兼容Milky(懒了🌚)，如果您有能力，可以尝试兼容Milky）
:::
